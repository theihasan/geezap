<div>
    ...
    <div class="bg-gradient-to-r from-purple-600 to-pink-500 mt-8 p-6 rounded-2xl border border-gray-700 text-center text-white">
        ...
        <div class="flex justify-center">
            <button wire:click="generateCoverLetter" class="px-8 py-3 bg-white text-pink-600 rounded-lg hover:bg-gray-200 transition font-medium text-lg flex items-center gap-2" onclick="generateCv()">
