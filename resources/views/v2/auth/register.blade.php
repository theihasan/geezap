...
@section('content')
    <div class="bg-[#12122b] rounded-2xl shadow-lg p-8 max-w-lg w-full space-y-6 border border-gray-800">
        ...
        <div class="flex flex-col gap-3">
            <button type="button" class="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl transition-all font-medium justify-center">
                <i class="lab la-facebook-f text-xl"></i> Continue with Facebook
            </button>
            <button type="button" class="flex items-center gap-3 bg-red-500 hover:bg-red-600 text-white px-6 py-2.5 rounded-xl transition-all font-medium justify-center">
                <i class="lab la-google text-xl"></i> Continue with Google
            </button>
            <button type="button" class="flex items-center gap-3 bg-gray-800 hover:bg-gray-900 text-white px-6 py-2.5 rounded-xl transition-all font-medium justify-center">
