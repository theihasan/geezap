...
@section('content')
        ...
        <div class="bg-[#12122b] rounded-2xl shadow-lg p-8 max-w-lg w-full space-y-8 border border-gray-800">
            ...
            <div class="flex flex-col gap-4 font-ubuntu-medium">
                <button type="button" class="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl transition-all font-medium justify-center">
                ...
                <button type="button" class="flex items-center gap-3 bg-gray-800 hover:bg-gray-900 text-white px-6 py-3 rounded-xl transition-all font-medium justify-center">
