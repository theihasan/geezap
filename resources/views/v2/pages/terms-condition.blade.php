...
@section('content')
        ...
        <div class="relative mx-auto max-w-7xl px-6">
            <div class="text-center mb-12">
                <h1 class="font-oxanium-bold text-5xl leading-tight text-white md:text-6xl mb-6">
                    Terms of <span class="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">Service</span>
                </h1>
    ...
    <section class="bg-[#0A0A1B] py-20">
        <div class="mx-auto max-w-4xl px-6">
            <div class="bg-[#12122b] rounded-2xl p-8 md:p-12 border border-gray-800">
                <!-- Overview -->
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                ...
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                            <span class="text-pink-500">6</span>
                        </div>
                        Intellectual Property
                    </h2>
                    <div class="text-gray-300 space-y-4">
                ...
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                            <span class="text-pink-500">7</span>
                        </div>
                        Data & Privacy
                    </h2>
                    <div class="text-gray-300 space-y-4">
                        <p>
                            Your use of Geezap is also governed by our <a href="{{ route('privacy-policy') }}" class="text-pink-400 hover:text-pink-500 transition">Privacy Policy</a>. We collect limited personal data to provide personalized experiences. We do not sell or share your data with employers or other users.
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                            <span class="text-pink-500">8</span>
                        </div>
                        Account Termination
                    </h2>
                    <div class="text-gray-300 space-y-4">
                ...
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                            <span class="text-pink-500">10</span>
                        </div>
                        Changes to Terms
                    </h2>
                    <div class="text-gray-300 space-y-4">
                ...
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500/20">
                            <span class="text-pink-500">11</span>
                        </div>
                        Contact
                    </h2>
                    <div class="text-gray-300 space-y-4">
                        ...
                        <div class="flex items-center gap-2 mt-4">
                            ...
                            <span>Email: <a href="mailto:contact@geezap.com" class="text-pink-400 hover:text-pink-500 transition">contact@geezap.com</a></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <i class="lab la-github text-pink-500"></i>
                            <span>GitHub: <a href="https://github.com/theihasan" target="_blank" class="text-pink-400 hover:text-pink-500 transition">github.com/theihasan</a></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <i class="lab la-linkedin text-pink-500"></i>
                            <span>LinkedIn: <a href="https://linkedin.com/in/theihasan" target="_blank" class="text-pink-400 hover:text-pink-500 transition">linkedin.com/in/theihasan</a></span>
                        </div>
                    </div>
                </div>
            </div>
