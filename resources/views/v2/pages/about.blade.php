...
@section('content')
    ...
    <section class="relative bg-[#12122b] py-20">
        ...
        <div class="relative mx-auto max-w-7xl px-6">
            <div class="text-center mb-12">
                <h1 class="font-oxanium-bold text-5xl leading-tight text-white md:text-6xl mb-6">
                    About <span class="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">Geezap</span>
                </h1>
                <p class="font-ubuntu-light text-xl leading-relaxed text-gray-100 max-w-3xl mx-auto">
        ...
        <div class="mx-auto max-w-7xl px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <div class="absolute -left-6 -top-6 rounded-xl border border-white/10 bg-[#1a1a3a]/90 p-4 backdrop-blur-sm">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-pink-500/20">
                                <i class="las la-rocket text-pink-500"></i>
                            </div>
                            <div>
                                <div class="font-medium text-white">Our Mission</div>
                                <div class="text-sm text-gray-400">Tech-Professional-First</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="absolute -right-6 -bottom-6 rounded-xl border border-white/10 bg-[#1a1a3a]/90 p-4 backdrop-blur-sm">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-purple-500/20">
                                <i class="las la-code text-purple-500"></i>
                            </div>
                            <div>
                                <div class="font-medium text-white">Software Engineer</div>
                                <div class="text-sm text-gray-400">Open-Source Enthusiast</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-gray-300">
                                <span class="font-medium text-white">Location:</span> Remote‑first (currently based in Dhaka)
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-pink-500/20">
                                <i class="lab la-github text-pink-500"></i>
                            </div>
                            <div class="text-gray-300">
                                <span class="font-medium text-white">GitHub:</span>
                                <a href="https://github.com/theihasan" target="_blank" class="text-pink-400 hover:text-pink-500 transition">github.com/theihasan</a>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-pink-500/20">
                                <i class="lab la-linkedin text-pink-500"></i>
                            </div>
                            <div class="text-gray-300">
                                <span class="font-medium text-white">LinkedIn:</span>
                                <a href="https://linkedin.com/in/theihasan" target="_blank" class="text-pink-400 hover:text-pink-500 transition">linkedin.com/in/theihasan</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-[#0A0A1B] py-20">
        <div class="mx-auto max-w-7xl px-6">
            <h2 class="text-3xl font-bold text-white mb-12 text-center">What Geezap Does</h2>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="group rounded-2xl border border-gray-700 bg-[#1a1a3a] p-8 transition hover:border-pink-500/50">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10 group-hover:bg-pink-500/20">
                        <i class="las la-search text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Aggregate</h3>
                    <ul class="space-y-3 text-gray-300">
                        <li class="flex items-start gap-2">
                            <i class="las la-check-circle text-pink-500 mt-1"></i>
                ...
                <div class="group rounded-2xl border border-gray-700 bg-[#1a1a3a] p-8 transition hover:border-pink-500/50">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10 group-hover:bg-pink-500/20">
                        <i class="las la-tags text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Enrich</h3>
                    <ul class="space-y-3 text-gray-300">
                        <li class="flex items-start gap-2">
                            <i class="las la-check-circle text-pink-500 mt-1"></i>
                ...
                <div class="group rounded-2xl border border-gray-700 bg-[#1a1a3a] p-8 transition hover:border-pink-500/50">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10 group-hover:bg-pink-500/20">
                        <i class="las la-paper-plane text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Apply</h3>
                    <ul class="space-y-3 text-gray-300">
                        <li class="flex items-start gap-2">
                            <i class="las la-check-circle text-pink-500 mt-1"></i>
        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="rounded-2xl bg-[#1a1a3a] p-8 border border-gray-700 hover:border-pink-500/50 transition">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10">
                        <i class="las la-users text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Tech-Professional-First</h3>
                ...
                <div class="rounded-2xl bg-[#1a1a3a] p-8 border border-gray-700 hover:border-pink-500/50 transition">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10">
                        <i class="las la-feather text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Simplicity</h3>
                    <p class="text-gray-300">
                ...
                <div class="rounded-2xl bg-[#1a1a3a] p-8 border border-gray-700 hover:border-pink-500/50 transition">
                    <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-pink-500/10">
                        <i class="las la-shield-alt text-3xl text-pink-500"></i>
                    </div>
                    <h3 class="mb-4 text-2xl font-semibold text-white">Privacy</h3>
                    <p class="text-gray-300">
    ...
    <section class="bg-[#0A0A1B] py-20">
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div class="rounded-2xl bg-[#12122b] p-8 border border-gray-700 hover:border-pink-500/50 transition flex items-center gap-4">
                    <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-pink-500/10">
                        <i class="las la-envelope text-2xl text-pink-500"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-white mb-1">Email</h3>
                        <a href="mailto:contact@geezap.com" class="text-pink-400 hover:text-pink-500 transition">contact@geezap.com</a>
                    </div>
                </div>

                <div class="rounded-2xl bg-[#12122b] p-8 border border-gray-700 hover:border-pink-500/50 transition flex items-center gap-4">
                    <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-pink-500/10">
                        <i class="lab la-github text-2xl text-pink-500"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-semibold text-white mb-1">GitHub Issues</h3>
                        <a href="https://github.com/theihasan/geezap" target="_blank" class="text-pink-400 hover:text-pink-500 transition">github.com/theihasan/geezap</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-[#12122b] py-20">
        <div class="mx-auto max-w-7xl px-6">
            <div class="rounded-2xl bg-gradient-to-r from-pink-500/20 to-purple-600/20 p-12 border border-white/10 relative overflow-hidden">
                <!-- Background Pattern -->
                <div class="absolute inset-0 opacity-10"
                     style="background-image: url('https://placehold.co/1920x800/2a2a4a/FFFFFF'); background-size: cover;"></div>

                <div class="relative text-center max-w-3xl mx-auto">
                    <h2 class="text-3xl font-bold text-white mb-6">Ready to Find Your Next Tech Role?</h2>
                    <p class="text-gray-300 text-lg mb-8">
                        Join thousands of tech professionals who have found their perfect roles through Geezap.
                    </p>
                    <a href="{{ route('job.index') }}"
                       class="font-ubuntu-regular inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-4 text-lg font-medium text-white transition-opacity hover:opacity-90">
                        Browse Jobs
