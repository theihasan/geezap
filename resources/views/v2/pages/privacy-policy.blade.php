        ...
        <div class="relative mx-auto max-w-7xl px-6">
            <div class="text-center mb-12">
                <h1 class="font-oxanium-bold text-5xl leading-tight text-white md:text-6xl mb-6">
                    Privacy <span class="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">Policy</span>
                </h1>
            ...
            <div class="bg-[#12122b] rounded-2xl p-8 md:p-12 border border-gray-800">
                ...
                <div class="mb-12">
                    ...
                    <div class="text-gray-300 space-y-4">
                        ...
                        <h3 class="text-xl font-semibold text-white mt-6 mb-3">Work Experience</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li>Job Titles</li>
                            <li>Company Names</li>
                        ...
                        <h3 class="text-xl font-semibold text-white mt-6 mb-3">Skills</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li>Technical or professional skills with optional proficiency levels</li>
                        </ul>

                        <h3 class="text-xl font-semibold text-white mt-6 mb-3">Social Media Links</h3>
                        <ul class="list-disc pl-6 space-y-2">
                            <li>GitHub</li>
                            <li>Facebook</li>
                            <li>Twitter/X</li>
                        ...
                        <h3 class="text-xl font-semibold text-white mt-6 mb-3">Account Credentials</h3>
                        <ul class="list-disc pl-6 space-y-2">
