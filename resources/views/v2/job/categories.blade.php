...
@section('content')
    ...
    <header class="bg-gray-50 dark:bg-[#12122b] border-b border-gray-200 dark:border-gray-800 py-6">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <p class="text-gray-600 dark:text-gray-300 font-sans">Explore a wide range of specialized categories to find the role that best suits your skills.</p>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto px-6">
            @if($jobCategories->isEmpty())
                <div class="text-center py-12">
                    <p class="text-gray-600 dark:text-gray-300 font-sans">No categories found</p>
                </div>
            @else
                    ...
                    @foreach($jobCategories as $category)
                        ...
                        border-gray-200 dark:border-gray-700 hover:border-blue-500/50 dark:hover:border-pink-500/50 transition">
                            <a href="{{ route('job.index', ['category' => $category->id]) }}"
                               class="flex flex-col items-start text-left font-sans">
