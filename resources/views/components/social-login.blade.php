<div class="flex flex-col gap-4 font-ubuntu-medium">
    ...
    <div class="relative">
        <a href="{{route('social.redirect', ['provider' => \App\Enums\SocialProvider::GOOGLE->value])}}"
           class="pointer-events-none flex items-center gap-3 bg-red-500/50 text-white px-6 py-3 rounded-xl transition-all font-medium justify-center">
    ...
    <div class="relative">
        <a href="{{route('social.redirect', ['provider' => \App\Enums\SocialProvider::GITHUB->value])}}"
           class="pointer-events-none flex items-center gap-3 bg-gray-800/50 text-white px-6 py-3 rounded-xl transition-all font-medium justify-center">
