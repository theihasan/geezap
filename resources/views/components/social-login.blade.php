<div class="flex flex-col gap-3 font-ubuntu-medium">
    ...
    <a href="{{route('social.redirect', ['provider' => \App\Enums\SocialProvider::GITHUB->value])}}"
       class="flex items-center gap-3 bg-gray-800/50 text-white px-8 py-3 rounded-full transition-all font-medium justify-center hover:bg-gray-800/70 hover:shadow-lg">
