...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    @foreach ($mostViewedJobs as $job)
        <div class="group relative bg-white dark:bg-[#1a1a3a] rounded-2xl overflow-hidden transition-all duration-300 hover:bg-gray-50 dark:hover:bg-[#1e1e4a] border border-gray-200 dark:border-gray-700"
            ...
            <div class="p-6">
                ...
                <div class="absolute top-6 right-6">
                    <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        <i class="las la-eye text-blue-600 dark:text-pink-500"></i>
                ...
                <div class="flex items-start gap-4 mb-6">
                    <div class="relative w-12 h-12 rounded-lg bg-gray-100 dark:bg-[#12122b] flex items-center justify-center overflow-hidden group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div>
                        <h4 class="text-gray-900 dark:text-white font-medium">{{ $job->employer_name }}</h4>
                ...
                <a href="{{ route('job.show', $job->slug) }}" class="block mb-6">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-pink-400 transition-colors">{{ $job->job_title }}</h3>
                </a>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6 text-sm">
                    ...
                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                        <i class="las la-clock text-blue-600/70 dark:text-purple-500/70"></i>
                ...
                @if ($job->min_salary && $job->max_salary)
                    <div class="flex items-baseline gap-2 mb-6">
                        <span class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-600 dark:from-pink-500 dark:to-purple-500">
                ...
                <!-- Action Bar -->
                <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700/30">
                    @if ($job->description)
                        <p class="text-gray-600 dark:text-gray-400 text-sm line-clamp-1 max-w-[60%]">{{ Str::limit(strip_tags($job->description), 80) }}</p>
                    @endif

                    <a href="{{ route('job.show', $job->slug) }}"
                       class="relative inline-flex items-center gap-2 text-gray-900 dark:text-white">
